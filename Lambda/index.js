...
var APP_ID = 'amzn1.ask.skill.17fdb47b-9940-4cac-ba29-ba8dd17bb182'; // TODO replace with your app ID (OPTIONAL).
...
var handlers = {
    ...
    'RecipeIntent': function () {
        ...
        if (recipe) {
            ...
            this.emit(':tellWithCard', recipe, this.attributes['speechOutput'], cardTitle, recipe);
        } else {
...
var languageStrings = {
    "en": {
        "translation": {
            ...
            "SKILL_NAME": "Unofficial Breath of the wild helper",
            "WELCOME_MESSAGE": "Welcome to %s. You can ask a question like, what\'s the recipe for a meat and seafood fry? ... Now, what can I help you with.",
            "WELCOME_REPROMPT": "For instructions on what you can say, please say help me.",
            "DISPLAY_CARD_TITLE": "%s  - Details for %s.",
    ...
    "en-US": {
        "translation": {
            "RECIPES" : recipes.RECIPE_EN_US,
            "SKILL_NAME" : "Unofficial American Breath of the wild helper"
        }
    },
    "en-GB": {
        "translation": {
            "RECIPES": recipes.RECIPE_EN_GB,
            "SKILL_NAME": "Unofficial British Breath of the wild helper"
        }
    },
    "de": {
        "translation": {
